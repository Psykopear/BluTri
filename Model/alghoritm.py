...
def triangolator(matrix,startPoint) :
 ...
 x = matrix[startPoint[0]][startPoint[1]][0]
 distance.append(x)
 y = matrix[startPoint[0] + modifier[direction][0]][startPoint[1] + modifier[direction][1]][0]
 distance.append(y)
 print punti
 while notarrived:
  print punti
...
# 8 = ARRIVATI
 ...
 if distance[1] < distance[0]:
  ...
  punti.append([punti[-1][0] + modifier[direction][0],punti[-1][1] + modifier[direction][1], punti[-1][2]])
  print punti
